...
CSVFILENAME='temperature_adress2.csv'
INFLUX_TIMESTAMPFORMAT="%Y-%m-%d_%H:%M:%S%z"
CSVFODERANDFILENAME=DATAFOLDER+CSVFILENAME
csvheaders = ['timestamp','R4DCB08_2_temp1','R4DCB08_2_temp2','R4DCB08_2_temp3','R4DCB08_2temp4','R4DCB08_2_temp5','R4DCB08_2_temp6','R4DCB08_2_temp7','R4DCB08_2_temp8']
